 ...
 */
Ext.define('CB.paper.PanelView', {
    extend: 'Ext.Container',
    xtype : 'cb-paper-panel',
    ...
    config: {
        ...
        html          : '<figure><img><canvas></canvas></figure>',
        errorImage    : false
    },
    ...
    initViewer: function() {
        ...
        me.canEl = me.figEl.down('canvas');
        
        paper.setup(me.canEl.dom);
        
        me.mixins.location.constructor.call(this);
        me.mixins.tools.constructor.call(this);
    ...
    onImageLoad : function() {
        ...
        me.canEl.setWidth(me.imgWidth);
        me.canEl.setHeight(me.imgHeight);
        ...
        var paths = [
            ["Path",{"segments":[[{"x":225,"y":291},{"x":0,"y":0},{"x":0,"y":-11.61269}],[{"x":198,"y":235},{"x":5.21643,"y":11.59207},{"x":-17.89498,"y":-39.76662}],[{"x":160,"y":114},{"x":0,"y":42.80142},{"x":0,"y":0}]],"strokeColor":[255,0,0],"strokeWidth":3}],
            ["Path",{"segments":[[{"x":303,"y":263},{"x":0,"y":0},{"x":73.25543,"y":-73.25543}],[{"x":366,"y":101},{"x":0,"y":92.12765},{"x":0,"y":0}]],"strokeColor":[255,0,0],"strokeWidth":3}],
            ["Path",{"segments":[[{"x":439,"y":300},{"x":0,"y":0},{"x":4.76008,"y":0}],[{"x":492,"y":250},{"x":-5.0186,"y":5.0186},{"x":53.44171,"y":-53.44171}],[{"x":567,"y":78},{"x":0,"y":71.77825},{"x":0,"y":0}]],"strokeColor":[255,0,0],"strokeWidth":3}]
        ];
        me.paths = [];
        for (var i = 0, len = paths.length; i < len; i++) {
            var path = new paper.Path();
            path.importJSON(paths[i]);
        ...
        paper.view.viewSize = new paper.Size(me.imgWidth * me.scale, me.imgHeight * me.scale);
    ...
    onImagePinch: function(ev) {
        ...
        /*
        var tx = me.scale / prev;
        console.log('transform', tx);
        var matrix = new paper.Matrix(tx,0,0,tx,0,0);
        for (var i = 0, len = me.paths.length; i < len; i++) {
            me.paths[i].transform(matrix);
        }
        */
    },
    ...
    setOrigin: function(x, y) {
        ...
        this.canEl.dom.style.webkitTransformOrigin = x + 'px ' + y + 'px';
    },
    ...
    applyTransform: function() {
        ...
        if (Ext.os.is.Android) {
            ...
            me.canEl.dom.style.webkitTransform = 'matrix(' + fixedScale + ',0,0,' + fixedScale + ',' + fixedX + ',' + fixedY + ')';
        } else {
            me.imgEl.dom.style.webkitTransform = 'translate3d(' + fixedX + 'px, ' + fixedY + 'px, 0)' + ' scale3d(' + fixedScale + ',' + fixedScale + ',1)';
            me.canEl.dom.style.webkitTransform = 'translate3d(' + fixedX + 'px, ' + fixedY + 'px, 0)' + ' scale3d(' + fixedScale + ',' + fixedScale + ',1)';
        }
    },
    ...
    destroy: function() {
        ...
        Ext.destroy(me.getScrollable(), me.imgEl, me.canEl);
